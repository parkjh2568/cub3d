...
/*   Updated: 2020/12/31 21:20:48 by junhypar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_extra_image2(t_game *g, int flag, t_img *img)
{
	...
	while (y < img->height)
	{
		...
		while (x < img->width)
		{
			g->ex_texture[flag][img->width * y + x] =
...
void	put_in_ex_texture(t_game *g)
{
	...
	load_extra_image(g, 2, "./tax/town_door.xpm", &img);
	load_extra_image(g, 3, "./tax/dragen.xpm", &img);
	...
	load_extra_image(g, 11, "./tax/crop.xpm", &img);
